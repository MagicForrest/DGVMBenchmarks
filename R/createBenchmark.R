...
createBenchmark <- function(benchmark_name, input, Datasets, spatial.extent = NULL){
  ...
  this_benchmark <- new("benchmark",
                        ...
                        file_name = input[[benchmark_name]][["Simulations"]][["File_name"]],
                        ...
                        adgvm.file.type = as.character(input[[benchmark_name]][["Simulations"]][["aDGVM_Specific"]][["adgvm.file.type"]]),
                        adgvm.fire = as.numeric(input[[benchmark_name]][["Simulations"]][["aDGVM_Specific"]][["adgvm.fire"]]),
                        adgvm.climate = as.numeric(input[[benchmark_name]][["Simulations"]][["aDGVM_Specific"]][["adgvm.climate"]]),
                        adgvm2.scheme = as.numeric(input[[benchmark_name]][["Simulations"]][["aDGVM2_Specific"]][["adgvm2.scheme"]]),
                        adgvm2.daily = as.logical(input[[benchmark_name]][["Simulations"]][["aDGVM2_Specific"]][["adgvm2.daily"]]),
                        ...
                        difference_limits = list(input[[benchmark_name]][["Plotting"]][["Spatial_Difference"]][["Difference_Limits"]]),
                        difference_breaks = list(input[[benchmark_name]][["Plotting"]][["Spatial_Difference"]][["Difference_Breaks"]]),
                        percentage.difference_limits = list(input[[benchmark_name]][["Plotting"]][["Spatial_Difference"]][["Percentage.difference_Limits"]]),
                        percentage.difference_breaks = list(input[[benchmark_name]][["Plotting"]][["Spatial_Difference"]][["Percentage.difference_Breaks"]]),
                        values_limits = list(input[[benchmark_name]][["Plotting"]][["Spatial_Difference"]][["Values_Limits"]]),
                        values_breaks = list(input[[benchmark_name]][["Plotting"]][["Spatial_Difference"]][["Values_Breaks"]]),
