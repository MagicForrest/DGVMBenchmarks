...
if(do_global_GPP & settings$doMapPlots){  
  ...
  GPP_abs_values_plot  <- GPP_abs_values_plot  + geom_text(data = total_label_df,  mapping = aes(x = x, y = y, label = label), size = 8)
...
if(do_global_GPP & settings$doMapPlots){  
  ...
  for(this_metric in this_benchmark@metrics) {
    ...
    GPP_diff_values_plot  <- GPP_diff_values_plot  + geom_text(data = metric_label_df,  mapping = aes(x = x, y = y, label = label), size = 8)
...
if(do_global_LAI & settings$doMapPlots){  
  ...
  LAI_abs_values_plot  <- LAI_abs_values_plot  + geom_text(data = total_label_df,  mapping = aes(x = x, y = y, label = label), size = 8)
...
if(do_global_LAI & settings$doMapPlots){  
  ...
  for(this_metric in this_benchmark@metrics) {
    ...
    LAI_diff_values_plot  <- LAI_diff_values_plot  + geom_text(data = metric_label_df,  mapping = aes(x = x, y = y, label = label), size = 8)
    lat_offset <- lat_offset + 10  
  }
...
if(do_global_BA & settings$doMapPlots){  
  ...
  BA_abs_values_plot  <- BA_abs_values_plot  + geom_text(data = total_label_df,  mapping = aes(x = x, y = y, label = label), size = 8)
...
if(do_global_BA & settings$doMapPlots){  
  ...
  for(this_metric in this_benchmark@metrics) {
    ...
    BA_diff_values_plot  <- BA_diff_values_plot  + geom_text(data = metric_label_df,  mapping = aes(x = x, y = y, label = label), size = 8)
    lat_offset <- lat_offset + 10  
  }
...
if(do_Global_Biomass & settings$doMapPlots){  
  ...
  Biomass_abs_values_plot  <- Biomass_abs_values_plot  + geom_text(data = total_label_df,  mapping = aes(x = x, y = y, label = label), size = 8)
...
if(do_Global_Biomass & settings$doMapPlots){  
  ...
  for(this_metric in this_benchmark@metrics) {
    ...
    Biomass_diff_values_plot  <- Biomass_diff_values_plot  + geom_text(data = metric_label_df,  mapping = aes(x = x, y = y, label = label), size = 8)
    lat_offset <- lat_offset + 10  
  }
