...
# Spatial extent 
# Note that this only applies to some benchmarks - typically the spatially explicit global ones
# it will be ignored for benchmarks such as the regrowth and Pan forest biomass benchmarks
spatial_extent <- subset_1600_gridcells # extent(c(xmin = -10, ymin = 35, xmax = 35, ymax  = 72)) # leave as NULL to use the whole simulation extent
spatial_extent_id <- "The1600" # "Europe" # "Global"  # set to a string to describe the spatial subset and use "Global" if not cropping area
