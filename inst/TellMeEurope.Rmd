...
do_ICOS_GPP <- input[["Switches"]][["do_ICOS_GPP"]]
```
***
# AGPP {.tabset}
...
```{r ICOS, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
if (do_ICOS_GPP){
  # Define which benchmark to do
...
plotICOSFields(this_benchmark, all_comparisons, plot.option = "joined")
#plotICOSScatter(this_benchmark,all_comparisons,fill="landuse")
