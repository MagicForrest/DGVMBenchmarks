...
# Process simulations and order together with dataset
...
## Make comparison onjects from your fields
...
## Spatial plotting of your comparisons
...
all_sim_full <- field_lists[[1]]
all_Fields_list <- field_lists[[2]]
#all_sim_full[[1]] <- convertUnits(all_sim_full[[1]],"indiv/ha","indiv/km2")
all_sim_full[[1]] <- convertUnits(all_sim_full[[1]],"indiv/ha","indiv/km2")
all_Fields_list[[2]] <- convertUnits(all_Fields_list[[2]],"indiv/ha","indiv/km2")
# all_Fields_list[[3]] <- convertUnits(all_Fields_list[[3]],"indiv/ha","indiv/km2")
